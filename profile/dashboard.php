          ...
          <table style="border-collapse: collapse; border: 1px solid black">
            ...
            <tr>
              ...
              <td>
                <center>
                  <h4>My Balance</h4>
                  <p id="balance">Rs. <?php echo $g11_balance ?></p>
                </center>
              </td>
            </tr>
          </table>
          ...
          <table style="border-collapse: collapse; border: 1px solid black">
            ...
            <tr>
              ...
              <td>
                <center>
                  <h4>Total Limit</h4>
                  <p id="tlimit">Rs. <?php echo $g11_online_limit + $g11 + card_limit ?></p>
                </center>
              </td>
            </tr>
          </table>
        ...
        <td>
          <table style="border-collapse: collapse; border: 1px solid black">
            ...
            <tr>
              ...
              <td>
                <center>
                  <h4>Online Transaction Limit</h4>
                  <p id="olimit">Rs. <?php echo $g11_online_limit ?></p>
                </center>
              </td>
            </tr>
          </table>
          ...
          <table style="border-collapse: collapse; border: 1px solid black">
            ...
            <tr>
              ...
              <td>
                <center>
                  <h4>Card Limit</h4>
                  <p id="climit">Rs. <?php echo $g11_card_limit ?></p>
                </center>
              </td>
            </tr>
          </table>
